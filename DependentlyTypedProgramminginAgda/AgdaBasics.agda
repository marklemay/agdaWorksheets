...
--how can it tellwhen something is structualy smaller
...
zero’ : Nat
zero’ = identity Nat zero --note the Nat typeparamiter is explicit

apply : (A : Set)(B : A -> Set) -> ((x : A) -> B x) -> (a : A) -> B a
apply A B f a = f a

identity2 : (A : Set) -> A -> A
identity2 = \A x -> x -- \ is the emacs butchuring of s forwardpath 
